<template>
  <div class="magic-input-page">
    ...
    <m-card class="m-b-5">
      <h4>px设置宽度</h4> <m-input v-model="value" width="180px"></m-input> 
      <h4>%设置宽度</h4><m-input v-model="value" width="50%"></m-input> 
    </m-card>
    ...
    <m-card class="m-b-5">
      <m-input disabled v-model="value" width="50%"></m-input> 
    </m-card>
    <m-show-box close-title="显示代码" open-title="隐藏代码" class="m-b-40" height="300px">
      <pre>
        <code>
    ...
    <m-card class="m-b-5">
      <m-input clearable v-model="value" width="50%"></m-input> 
    </m-card>
    <m-show-box close-title="显示代码" open-title="隐藏代码" class="m-b-40" height="300px">
      <pre>
        <code>
    ...
    <m-card class="m-b-5">
      <m-input show-password v-model="value" type="password" width="50%"></m-input> 
    </m-card>
    <m-show-box close-title="显示代码" open-title="隐藏代码" class="m-b-40" height="300px">
      <pre>
        <code>
